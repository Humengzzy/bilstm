...
def creat_model():
    ...
    lstmLayer =Bidirectional(LSTM(units=32, return_sequences=True),input_shape=(41, 4))(input)
    attention_mul=attention_block_3(lstmLayer,41,64)
    flattenLayer=Flatten()(attention_mul)
